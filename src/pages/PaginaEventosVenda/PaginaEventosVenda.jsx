...
const eventos = [
  ...
  ...Array.from({ length: 12 }, (_, i) => ({
    ...
    descricao: [`Evento sobre "Networking Estratégico`, `Entrevistas de Emprego: Dicas e Simulações`, `Matemática Divertida: Jogos e Desafios`,`Aventuras em Ciências: Experimentos Interativos`,`Meditação Guiada para Iniciantes`, `Comunicação Profissional para Jovens`][i % 6],
